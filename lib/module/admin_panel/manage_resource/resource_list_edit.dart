...
class ResourceListEdit extends StatefulWidget {
  final TextEditingController controller;

  const ResourceListEdit({Key? key, required this.controller}) :
        super(key: key);

  @override
  ResourceListEditState createState() => ResourceListEditState();
}

class ResourceListEditState extends State<ResourceListEdit> {
  ...
  void _editResource(String resourceId) async {
    editResource(context, resourceId);
  }
